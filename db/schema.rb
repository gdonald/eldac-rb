...
ActiveRecord::Schema.define(version: 20) do
  ...
  create_table 'field_opts', force: :cascade do |t|
    ...
    t.index %w[field_id name], name: 'index_field_opts_on_field_id_and_name', unique: true, using: :btree
  ...
  create_table 'fields', force: :cascade do |t|
    ...
    t.index %w[section_id name], name: 'index_fields_on_section_id_and_name', unique: true, using: :btree
  ...
  create_table 'forms', force: :cascade do |t|
    ...
    t.index %w[project_id name], name: 'index_forms_on_project_id_and_name', unique: true, using: :btree
  ...
  create_table 'pages', force: :cascade do |t|
    ...
    t.string  'name', limit: 64, null: false
    t.integer 'position', default: 0, null: false
    t.index %w[form_id name], name: 'index_pages_on_form_id_and_name', unique: true, using: :btree
  ...
  create_table 'project_folders', force: :cascade do |t|
    ...
    t.index %w[user_id project_id folder_id], name: 'user_proj_fold', unique: true, using: :btree
  ...
  create_table 'sections', force: :cascade do |t|
    ...
    t.index %w[page_id name], name: 'index_sections_on_page_id_and_name', unique: true, using: :btree
  ...
  create_table 'user_projects', force: :cascade do |t|
    ...
    t.index %w[user_id project_id relationship_id], name: 'user_proj_rel', unique: true, using: :btree
  ...
  create_table 'user_tokens', force: :cascade do |t|
    ...
    t.index %w[user_id token_type_id], name: 'index_user_tokens_on_user_id_and_token_type_id', unique: true, using: :btree
  end
  ...
  create_table 'values', force: :cascade do |t|
    ...
    t.index %w[record_id field_id], name: 'index_values_on_record_id_and_field_id', unique: true, using: :btree
