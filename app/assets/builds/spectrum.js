(() => {
  ...
  // app/javascript/spectrum.js
  var require_spectrum = __commonJS({
    "app/javascript/spectrum.js"(exports, module) {
      (function(factory) {
        "use strict";
        if (typeof define === "function" && define.amd) {
        ...
        function paletteTemplate(p, color, className, opts) {
          ...
          for (var i = 0; i < p.length; i++) {
            ...
            if (current) {
              ...
              html.push(
                $("<div />").append(
                  $('<span data-color="" style="background-color:transparent;" class="' + cls + '"></span>').attr("title", opts.noColorSelectedText)
                ).html()
              );
            }
          }
        ...
        function spectrum(element, o) {
          ...
          function drawPalette() {
            ...
            var html = $.map(paletteArray, function(palette2, i) {
...
jquery/dist/jquery.js:
   ...
   *)
*/
//# sourceMappingURL=assets/spectrum.js.map
